...
topics['world/us_and_canada'] = createSection('world/us_and_canada');


function fillCategories() {
$.ajax({
		  url: "interface.php?url=http://bbc.api.mashery.com/content/asset/news/" + "world/us_and_canada" + "?api_key=" + "55e5w5gwnjyfg7z5rd7v8s93",
		  success: function( data ) {
			topics['world/us_and_canada'].extractSectionIndexData(jQuery.parseJSON(data));
...
function buildPreview(id) {
	...
	//alert(this.id);
		if(this.id == id) {
			  ...
			  previewElements.push("<div id='preview_link'>[<a href='http://euanmorrison.co.uk/newshack/d3/nodes.html'>read more...</a>]</div>");
